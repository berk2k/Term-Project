    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.notificationFragment-> {
                val action =
                    UserFragmentDirections.actionUserFragmentToNotificationFragment()
                findNavController().navigate(action)
            }
            R.id.chatGptFragment-> {
                val action =
                    UserFragmentDirections.actionUserFragmentToChatGptFragment()
                findNavController().navigate(action)
            }
            R.id.addPetFragment-> {
                val action =
                    UserFragmentDirections.actionUserFragmentToAddPetFragment()
                findNavController().navigate(action)
            }
            R.id.appointmentsFragment-> {
                val action =
                    UserFragmentDirections.actionUserFragmentToAppointmentsFragment()
                findNavController().navigate(action)
            }
            else -> {
                return false
