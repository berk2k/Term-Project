    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.appointmentsFragment -> {
                val action =
                    AddPetFragmentDirections.actionAddPetFragmentToAppointmentsFragment()
                findNavController().navigate(action)
            }
            ...
            R.id.chatGptFragment-> {
                val action =
                    AddPetFragmentDirections.actionAddPetFragmentToChatGptFragment()
                findNavController().navigate(action)
            }
            ...
            R.id.notificationFragment-> {
                val action =
                    AddPetFragmentDirections.actionAddPetFragmentToNotificationFragment()
                findNavController().navigate(action)
            }
