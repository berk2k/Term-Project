...
class MainPageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.floatingActionButton.setOnClickListener{
            val action =
                com.example.vetapp.MainPageFragmentDirections.actionMainPageFragmentToMessageFragment()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.appointmentsFragment -> {
                val action =
                    MainPageFragmentDirections.actionMainPageFragmentToAppointmentsFragment()
                findNavController().navigate(action)
            }
            ...
            R.id.chatGptFragment-> {
                val action =
                    MainPageFragmentDirections.actionMainPageFragmentToChatGptFragment()
                findNavController().navigate(action)
            }
            ...
            R.id.notificationFragment-> {
                val action =
                    MainPageFragmentDirections.actionMainPageFragmentToNotificationFragment()
                findNavController().navigate(action)
            }

            R.id.addPetFragment-> {
                val action =
                    MainPageFragmentDirections.actionMainPageFragmentToAddPetFragment()
                findNavController().navigate(action)
            }
            else -> {
                return false
